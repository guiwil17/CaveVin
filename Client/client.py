...
class main(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for F in (PageAccueil, PageRechercher, PageAjouterVin, PageAjouterCave):
...
class PageAccueil(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(can, text="Mes Caves", padx=59, font=("Montserrat", 12, "bold"), pady=0, bg="#AC1E44",
                         fg="white", command=lambda: controller.show_frame(PageAjouterVin))
        button1.place(x=50, y=200)
        button2 = tk.Button(can, text="Visiter des Caves", padx=30, font=("Montserrat", 12, "bold"), pady=0, bg="#AC1E44",
                         fg="white", command=lambda: controller.show_frame(PageRechercher))
        button2.place(x=320, y=200)

class PageRechercher(tk.Frame):
